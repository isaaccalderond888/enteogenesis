...
/**
 * Bandas de severidad con la paleta de Enteogénesis. Portadas de landingPB, que
 * usaba sus propias variables de marca: los nombres (mint, teal, gold, red, mid)
 * se conservan para que las definiciones de las escalas no cambien ni una línea,
 * y sólo cambia el color al que apuntan.
 */
const B = {
  mint:  { textClass: "text-sage",       barClass: "bg-sage" },
  teal:  { textClass: "text-moss",       barClass: "bg-moss" },
  gold:  { textClass: "text-review",     barClass: "bg-review" },
  red:   { textClass: "text-hold",       barClass: "bg-hold" },
  mid:   { textClass: "text-taupe",      barClass: "bg-taupe" },
};
...
export const TEST_CONFIGS: Record<TestId, TestConfig> = {
  PHQ9: {
    ...
    borderClass: "border-moss/40 hover:border-moss",
    btnSelectedClass: "bg-moss border-moss text-white",
    btnHoverClass: "hover:border-moss/50 hover:text-moss",
    barClass: "bg-moss",
    questions: [
  ...
  GAD7: {
    ...
    accentClass: "text-review",
    borderClass: "border-review/40 hover:border-review",
    btnSelectedClass: "bg-review border-review text-ink",
    btnHoverClass: "hover:border-review/50 hover:text-review",
    barClass: "bg-review",
    questions: [
  ...
  DASS21: {
    ...
    borderClass: "border-sage/40 hover:border-sage",
    btnSelectedClass: "bg-sage border-sage text-ink",
    btnHoverClass: "hover:border-sage/50 hover:text-sage",
    barClass: "bg-sage",
    questions: [
  ...
  PCL5: {
    ...
    accentClass: "text-taupe",
    borderClass: "border-taupe/40 hover:border-taupe",
    btnSelectedClass: "bg-taupe border-taupe text-white",
    btnHoverClass: "hover:border-taupe/50 hover:opacity-100",
    barClass: "bg-taupe",
    questions: [
  ...
  DESII: {
    ...
    accentClass: "text-moss",
    borderClass: "border-moss/30 hover:border-moss",
    btnSelectedClass: "bg-moss border-moss text-white",
    btnHoverClass: "hover:border-moss/50 hover:text-moss",
    barClass: "bg-moss",
    questions: [
  ...
  CBI: {
    ...
    accentClass: "text-review",
    borderClass: "border-review/30",
    btnSelectedClass: "bg-review/20 border border-review text-review",
    btnHoverClass: "hover:bg-review/10 hover:border-review/40",
    barClass: "bg-review",
  ...
  AQ10: {
    ...
    btnSelectedClass: "bg-moss/20 border border-moss text-moss",
    btnHoverClass: "hover:bg-moss/10 hover:border-moss/40",
    barClass: "bg-moss",
  ...
  CATQ: {
    ...
    accentClass: "text-taupe",
    borderClass: "border-taupe/30",
    btnSelectedClass: "bg-taupe/20 border border-taupe text-taupe",
    btnHoverClass: "hover:bg-taupe/10 hover:border-taupe/40",
    barClass: "bg-taupe",
  ...
  ASRS: {
    ...
    btnSelectedClass: "bg-sage/20 border border-sage text-sage",
    btnHoverClass: "hover:bg-sage/10 hover:border-sage/40",
    barClass: "bg-sage",
